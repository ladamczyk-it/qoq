# @ladamczyk/qoq-eslint-v9-ts-vitest
...
![NPM Type Definitions](https://img.shields.io/npm/types/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest) ![NPM Unpacked Size](https://img.shields.io/npm/unpacked-size/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest) ![NPM License](https://img.shields.io/npm/l/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest)
...
## Install
    ...
    npm install @ladamczyk/qoq-eslint-v9-ts-vitest
...
```js
const jsBaseConfig = require("@ladamczyk/qoq-eslint-v9-ts-vitest");
...
```js
import jsBaseConfig from '@ladamczyk/qoq-eslint-v9-ts-vitest';
...
To preview all rules defined by this config simply run:
    ...
    npx -y @ladamczyk/qoq-eslint-v9-ts-vitest
