...
Consumer-facing context (exported functions and their signatures) lives in `AGENTS.md` — shipped with the npm package at `node_modules/@saashub/qoq-utils/AGENTS.md`.
