...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/ladamczyk-it/qoq/main.yml) ![NPM Version](https://img.shields.io/npm/v/%40ladamczyk%2Fqoq-eslint-v9-js-vitest)
![NPM Type Definitions](https://img.shields.io/npm/types/%40ladamczyk%2Fqoq-eslint-v9-js-vitest) ![NPM Unpacked Size](https://img.shields.io/npm/unpacked-size/%40ladamczyk%2Fqoq-eslint-v9-js-vitest) ![NPM License](https://img.shields.io/npm/l/%40ladamczyk%2Fqoq-eslint-v9-js-vitest)
...
## Install
    ...
    npm install @ladamczyk/qoq-eslint-v9-js-vitest
...
```js
const jsBaseConfig = require("@ladamczyk/qoq-eslint-v9-js-vitest");
...
```js
import jsBaseConfig from '@ladamczyk/qoq-eslint-v9-js-vitest';
...
To preview all rules defined by this config simply run:
    ...
    npx -y @ladamczyk/qoq-eslint-v9-js-vitest
