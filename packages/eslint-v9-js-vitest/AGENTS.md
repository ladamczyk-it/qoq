# @saashub/qoq-eslint-v9-js-vitest — Agent Context

ESLint flat config template for JavaScript test files using Vitest. Extends `@saashub/qoq-eslint-v9-js`.
...
```js
import { baseConfig } from '@saashub/qoq-eslint-v9-js-vitest';
