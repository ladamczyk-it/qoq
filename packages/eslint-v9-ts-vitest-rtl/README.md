# @ladamczyk/qoq-eslint-v9-ts-vitest-rtl

![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/ladamczyk-it/qoq/main.yml) ![NPM Version](https://img.shields.io/npm/v/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest-rtl)
![NPM Type Definitions](https://img.shields.io/npm/types/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest-rtl) ![NPM Unpacked Size](https://img.shields.io/npm/unpacked-size/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest-rtl) ![NPM License](https://img.shields.io/npm/l/%40ladamczyk%2Fqoq-eslint-v9-ts-vitest-rtl)
...
## Install
    ...
    npm install @ladamczyk/qoq-eslint-v9-ts-vitest-rtl
...
```js
const jsBaseConfig = require("@ladamczyk/qoq-eslint-v9-ts-vitest-rtl");
...
```js
import jsBaseConfig from '@ladamczyk/qoq-eslint-v9-ts-vitest-rtl';
...
To preview all rules defined by this config simply run:
    ...
    npx -y @ladamczyk/qoq-eslint-v9-ts-vitest-rtl
