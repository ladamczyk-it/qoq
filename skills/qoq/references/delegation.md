...
| `lens.B.model` | `design-pattern-review` | `sonnet` (default)   | Not yet validated on a cheaper tier. Keep it here until evals exist to justify moving it — don't guess a cheaper tier. |
