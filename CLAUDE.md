...
**QoQ (Quality over Quantity)** is a monorepo of npm packages published under `@saashub/qoq-*` that orchestrate Prettier, ESLint, Knip, JSCPD, Stylelint, and Skillslint via a single CLI. Node >=22.13.1 is required.
